...
export type MutationGetOrCreateChannelArgs = {
  input: GetOrCreateChannelInput;
};
...
export type GetOrCreateChannelMutationVariables = Exact<{
  input: GetOrCreateChannelInput;
}>;
...
/**
 * __useGetOrCreateChannelMutation__
 *
 * To run a mutation, you first call `useGetOrCreateChannelMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useGetOrCreateChannelMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [getOrCreateChannelMutation, { data, loading, error }] = useGetOrCreateChannelMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetOrCreateChannelMutation(baseOptions?: Apollo.MutationHookOptions<GetOrCreateChannelMutation, GetOrCreateChannelMutationVariables>) {
        return Apollo.useMutation<GetOrCreateChannelMutation, GetOrCreateChannelMutationVariables>(GetOrCreateChannelDocument, baseOptions);
      }
export type GetOrCreateChannelMutationHookResult = ReturnType<typeof useGetOrCreateChannelMutation>;
export type GetOrCreateChannelMutationResult = Apollo.MutationResult<GetOrCreateChannelMutation>;
export type GetOrCreateChannelMutationOptions = Apollo.BaseMutationOptions<GetOrCreateChannelMutation, GetOrCreateChannelMutationVariables>;
